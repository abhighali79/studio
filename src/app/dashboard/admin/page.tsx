...
const initialMockProducts: Product[] = [
  { id: 'admin-1', name: 'Admin Laptop Sample', brand: 'AdminBrand', model: 'AB-LPX-15', price: 85000, description: 'This is a sample product visible on the admin panel.', image: 'https://placehold.co/600x400.png', image_hint: 'laptop device' },
  { id: 'admin-2', name: 'Admin Phone Sample', brand: 'AdminConnect', model: 'AC-SU-67', price: 55000, description: 'Another sample product for admin management.', image: 'https://placehold.co/600x400.png', image_hint: 'phone mobile' },
];
